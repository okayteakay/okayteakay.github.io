...
> 🔬 An empirical probe of GPT robustness to deliberately misleading retrieval contexts on a SQuAD multiple-choice benchmark.
>
> 🐙 GitHub: [okayteakay/Navigating-Misleading-Context-in-Retrieval-Augmented-Generation-](https://github.com/okayteakay/Navigating-Misleading-Context-in-Retrieval-Augmented-Generation-)
...
OpenAI GPT, SQuAD v1, Python, Jupyter.
